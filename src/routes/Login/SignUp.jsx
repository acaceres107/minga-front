...
const SignUp = () => {
  ...
  return (
    <div className="box">
      <div
        className="grow bkg div2"
        style={{
          opacity: "0,2 ",
          backgroundImage:
            "url('https://images.pexels.com/photos/7809123/pexels-photo-7809123.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')",
        }}
      ></div>
      <form action="post" id="form1" className="grow col flex">
        ...
        <div className="letrero">
          ...
          <Anchor className="button-start1" to="/signin">
            Login!
          </Anchor>
        </div>
      </form>
